...
def risultati():
    ...
    """processare la query qui. mandarla ai due indici. Pseudocodice:
        x,y = process_query(query, 'instant_gaming') # ritorna i risultati della query. In process cercherà sia in instant gaming, sia in m
        multiplayer
        y = process_query(query, 'multiplayer')
        risultati = threshold (x,y)
        renderizza risultati a results.hmtl
        """
